...
#define LIGHT_RX_PIN GPIO_NUM_12
#define LIGHT_TX_PIN GPIO_NUM_13

#define PWM_LED_GPIO GPIO_NUM_11

#define PWM_LED_UART_TX_PIN GPIO_NUM_10
#define PWM_LED_UART_RX_PIN GPIO_NUM_NC
